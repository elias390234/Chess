...
public interface Grid<E>
{
    ...
    /**
     * Gets the neighboring occupants in the surrounding area (a surrounding 
     * square with a specified length away from the center location).
     * <br />
     * Precondition: <code>loc</code> is valid in this grid
     * @param loc a location in this grid
     * @param range the range to which neighbors should be retrieved
     * @return returns an array list of the objects in the occupied locations
     * adjacent to <code>loc</code> in this grid
     */
